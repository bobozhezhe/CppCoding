...
//  vSendString("Ethernet LINKED\n\r");
    ...
    *filrt_data2 = 0x925f;
    ...
    volatile unsigned int *PING_recv_data = (unsigned int *) (0x61020000);
    ...
    //block 1
    i = 0;
    volatile unsigned int *t_ram = (unsigned int *) (0x61000000 + 4*i);
    *t_ram = 0xffffffff;
    ...
    *axi4_wr_data = 0x61000000; // tran start addr
...
//              vSendString("REPLY ARP DONE\n\r");
            ...
            else if((r_ram[3] == 0x450008) & ((r_ram[5] & 0x01000000) == 0x01000000)){
